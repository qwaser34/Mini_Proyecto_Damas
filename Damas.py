...
class PiesesWhiteBlack(DamasChinas):
    turn = False
    def movement(self, Row_Postion_Current,Column_Postion_current,Row_Postion_Late,Column_Postion_Late,turn):
    ...
    def movement_pieses(self):
        ...
        while(True):
            ...
            Value_Row_White = Row_Postion_Late - Row_Postion_Current
            Value_Col_White = Column_Postion_Late - Column_Postion_current
            Value_Row_Black = Row_Postion_Current - Row_Postion_Late
            Value_Col_Black = Column_Postion_current - Column_Postion_Late

            if(self.Board[Row_Postion_Current][Column_Postion_current] == self.Pieses_White and abs(Value_Row_White) == 1):
                    if(self.Board[Row_Postion_Late][Column_Postion_Late] == self.Pieses_Black):
                        self.Board[Row_Postion_Late][Column_Postion_Late] = '⬛'
                        if(Value_Row_White >= 0):
                            Row_Postion_Late=Row_Postion_Late+1 #fila de comer
                            Column_Postion_Late=Column_Postion_Late-1 #columna de comer
                        else:
                            Row_Postion_Late=Row_Postion_Late-1
                            Column_Postion_Late=Column_Postion_Late+1
                        self.movement(Row_Postion_Current,Column_Postion_current,Row_Postion_Late,Column_Postion_Late,PiesesWhiteBlack.turn)
                        os.system("cls")
                        self.presentation()
                        PiesesWhiteBlack.turn = False
                        print("shift change, Black")
                        # r = r + 1
                        # self.verification(r) #aqui iba el i+=1
                    else:
                        self.movement(Row_Postion_Current,Column_Postion_current,Row_Postion_Late,Column_Postion_Late,PiesesWhiteBlack.turn)
                        os.system("cls")
                        self.presentation()
                ...
                if(self.Board[Row_Postion_Current][Column_Postion_current] == self.Pieses_Black and PiesesWhiteBlack.turn == False and abs(Value_Row_Black) == 1 and Value_Col_Black <= 1):
                    if(self.Board[Row_Postion_Late][Column_Postion_Late] == self.Pieses_White):
                        self.Board[Row_Postion_Late][Column_Postion_Late] = '⬛'
                        if(Value_Row_Black <= 0):
                            Row_Postion_Late=Row_Postion_Late+1 # fila de comer
                            Column_Postion_Late=Column_Postion_Late+1 #columna de comer
                        else:
                            Row_Postion_Late=Row_Postion_Late-1
